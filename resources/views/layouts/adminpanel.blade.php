...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('public/backend/css/toastr.css')}}">
    <link rel="stylesheet" href="{{asset('public/backend/css/tagsinput.css')}}">
    
    <link href="{{asset('public/backend/lib/medium-editor/medium-editor.css')}}" rel="stylesheet">
    <link href="{{asset('public/backend/lib/medium-editor/default.css')}}" rel="stylesheet">
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href="{{ route('admin.dashboard') }}"><i class="icon ion-android-star-outline"></i> E-Commerce</a></div>
    <div class="sl-sideleft">
      <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
          ...
          <li class="nav-item"><a href="{{ route('admin.subcategory') }}" class="nav-link">Sub Category</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ route('admin.cupons') }}" class="nav-link">Cupon</a></li>
        </ul>
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon ion-ios-pie-outline tx-20"></i>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ route('admin.post.category') }}" class="nav-link">Add Category</a></li>
          <li class="nav-item"><a href="{{ route('admin.all.post') }}" class="nav-link">All Post</a></li>
        </ul>
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
